                                            ...
                                            <table id="example2" className="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                                ...
                                                <tbody>
                                                    <tr role="row" className="odd">
                                                        ...
                                                        <td>oject</td>
                                                        <td>
                                                            <button type="button" className="btn btn-danger"><i class="fa fa-check" aria-hidden="true"></i></button>
                                                        </td>
                                                        <td> 
                                                            {/* <Link to="/teacher/Showhistorycourse"> <button type="button" className="btn btn-primary"><i class="fa fa-eye" aria-hidden="true"></i></button> </Link> */}
                                                            <Link to="/student/Camera"><button type="button" className="btn btn-warning"><i class="fa fa-camera" aria-hidden="true"></i></button> </Link>
                                                            {/* <button type="button" className="btn btn-danger"><i class="fa fa-check" aria-hidden="true"></i></button> */}
                                                        </td>
                                                    </tr>
                                                </tbody>
